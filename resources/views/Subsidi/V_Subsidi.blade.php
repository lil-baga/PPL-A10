...
@section('content')
    <div class="w-full bg-slate-200 scrollbar">
        ...
        <div class="px-12 py-12">
            <div class="flex text-center items-center justify-center content-center bg-cover bg-center bg-no-repeat bg-[url('img/assets/fotopakan.png')] bg-slate-500 bg-blend-multiply w-full h-16 mb-4 rounded-lg">
                                    ...
                                    @foreach ($subsidiPakan as $sp)
                                        @if ($sp->users_id == $id)
                                            <tr>
                                                ...
                                                <td class="p-4 border border-slate-300">
                                                    <div class="flex flex-col items-center justify-center">
                                                        @if ($sp->tanggal_pengambilan == null)
                                                            <p
                                                                class="flex antialiased leading-normal text-slate-900 font-normal">
                                                                Belum ada Tanggal...
                                                            </p>
                                                        @else
                                                            <p
                                                                class="flex antialiased leading-normal text-slate-900 font-normal">
                                                                {{ $sp->tanggal_pengambilan->translatedFormat('l, d F Y H:i') }}
                                                            </p>
                                                        @endif
                                                    </div>
                                                </td>

            ...
            @endif
              <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div class="flex-col items-center justify-center">
                        <a href="{{ route('subsidi.validate', $foodSubmissions->id) }}" class="items-center justify-center w-full button bg-green-500 inset-y-0 left-0 top-0 flex flex-col-reverse bottom-0 ml-2 hover:cursor-pointer hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Validasi</a>
                    </div>
              </div>
          </div>
    </div>

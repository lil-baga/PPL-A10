    ...
    <div class="flex flex-row">
        ...
        <div class="w-full bg-white rounded-lg shadow md:mt-0 xl:p-0">
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="{{ route('edit.profilDinas') }}" method="GET"
                    ...
                    <div>
                        ...
                        <input type="text" name="phone_number" id="phone_number" placeholder="Nomor Telepon"
                            readonly value="{{ $currentuser->phone_number }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#F5682A] focus:border-[#F5682A] block w-full p-2.5"
                            required="">
                    </div>
                    <button type="submit"
                        class="w-full text-white bg-[#F5682A] hover:bg-[#F54C2A] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Ubah</button>
                </form>
            </div>
        </div>
    </div>

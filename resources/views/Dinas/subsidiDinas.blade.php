        ...
        <thead>
          <tr>
            <th class="cursor-pointer border-y border-[#F54C2A] bg-[#F5682A] p-4 transition-colors hover:bg-[#F54C2A]">
              <p class="antialiased font-sans text-sm text-white flex items-center justify-center gap-2 font-normal leading-none">No.</p>
            </th>
            <th class="cursor-pointer border-y border-[#F54C2A] bg-[#F5682A] p-4 transition-colors hover:bg-[#F54C2A]">
              <p class="antialiased font-sans text-sm text-white flex items-center justify-center gap-2 font-normal leading-none">Surat Pengantar</p>
            </th>
            <th class="cursor-pointer border-y border-[#F54C2A] bg-[#F5682A] p-4 transition-colors hover:bg-[#F54C2A]">
              <p class="antialiased font-sans text-sm text-white flex items-center justify-center gap-2 font-normal leading-none">Surat Usaha</p>
            </th>
            <th class="cursor-pointer border-y border-[#F54C2A] bg-[#F5682A] p-4 transition-colors hover:bg-[#F54C2A]">
              <p class="antialiased font-sans text-sm text-white flex items-center justify-center gap-2 font-normal leading-none">Jumlah Ternak</p>
            </th>
            <th class="cursor-pointer border-y border-[#F54C2A] bg-[#F5682A] p-4 transition-colors hover:bg-[#F54C2A]">
              <p class="antialiased font-sans text-sm text-white flex items-center justify-center gap-2 font-normal leading-none">Ajuan Pakan (Kwintal)</p>
            </th>
            <th class="cursor-pointer border-y border-[#F54C2A] bg-[#F5682A] p-4 transition-colors hover:bg-[#F54C2A]">
              <p class="antialiased font-sans text-sm text-white flex items-center justify-center gap-2 font-normal leading-none">Foto Peternakan</p>
            </th>
            <th class="cursor-pointer border-y border-[#F54C2A] bg-[#F5682A] p-4 transition-colors hover:bg-[#F54C2A]">
              <p class="antialiased font-sans text-sm text-white flex items-center justify-center gap-2 font-normal leading-none">Validasi</p>
            </th>
            <th class="cursor-pointer border-y border-[#F54C2A] bg-[#F5682A] p-4 transition-colors hover:bg-[#F54C2A]">
              <p class="antialiased font-sans text-sm text-white flex items-center justify-center gap-2 font-normal leading-none">Foto Penerimaan</p>
            </th>
            <th class="cursor-pointer border-y border-[#F54C2A] bg-[#F5682A] p-4 transition-colors hover:bg-[#F54C2A]">
              ...
              <tr>
                ...
                <td class="p-4 border-b border-gray-400">
                  <div class="flex flex-row items-center justify-center">
                    <a href="{{ route('detail.subsidiDinas', $fs->id) }}" class="button bg-blue-500 inset-y-0 left-0 top-0 flex flex-col-reverse bottom-0 ml-2 hover:cursor-pointer hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                      Detail
                    </a>
                  </div>
                </td>

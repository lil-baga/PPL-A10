    ...
    <div class="w-full bg-white rounded-lg shadow md:mt-0 xl:p-0">
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="" method="GET"
                ...
                <a href="{{ route('edit.profilPeternak', $currentuser->id) }}" class="items-center justify-center w-full button bg-[#F5682A] hover:bg-[#F54C2A] inset-y-0 left-0 top-0 flex flex-col-reverse bottom-0 hover:cursor-pointer text-white font-bold py-2 px-4 rounded">Ubah</a>
            </form>
        </div>
    </div>
@endsection

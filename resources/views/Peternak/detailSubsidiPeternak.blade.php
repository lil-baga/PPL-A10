        ...
        <div
            ...
            <nav class="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
                <div role="button" tabindex="0"
                    ...
                    </div><a href="/subsidiPeternak">Pengajuan Pakan Subsidi</a>
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <div>
                    <label for="food_quantity" class="block mb-1 font-medium text-sm text-gray-900">Ajuan Pakan
                        (Kwintal)</label>
                    <input type="text" name="name" id="food_quantity" placeholder="Ajuan Pakan (Kwintal)"
                        readonly value="{{ $foodSubmissions->food_quantity }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#F5682A] focus:border-[#F5682A] block w-full p-2.5"
                        required="">
                </div>
                <div>
                ...
                <div class="flex-col items-center justify-center">
                    <a href="{{ route('subsidi.edit', $foodSubmissions->id) }}"
                        class="items-center justify-center w-full button bg-blue-500 inset-y-0 left-0 top-0 flex flex-col-reverse bottom-0 ml-2 hover:cursor-pointer hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Ubah</a>
                    <button id="deleteButton" data-modal-target="deleteModal" data-modal-toggle="deleteModal"
                        class="items-center justify-center w-full button bg-red-500 inset-y-0 left-0 top-0 mt-4 flex flex-col-reverse bottom-0 ml-2 hover:cursor-pointer hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
                            ...
                            <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
                                ...
                                <div class="flex justify-center items-center space-x-4">
                                    ...
                                    <form id='delete' method="POST"
                                        action="{{ route('subsidi.destroy', $foodSubmissions->id) }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"

            ...
            @endif
              <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div class="flex-col items-center justify-center">
                        <a href="{{ route('subsidi.edit', $foodSubmissions->id) }}" class="items-center justify-center w-full button bg-blue-500 inset-y-0 left-0 top-0 flex flex-col-reverse bottom-0 ml-2 hover:cursor-pointer hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Ubah</a>
                        <form id='delete' method="POST" action="{{ route('subsidi.destroy', $foodSubmissions->id) }}">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="items-center justify-center w-full bg-red-500 mt-4 inset-y-0 left-0 top-0 flex flex-col-reverse bottom-0 ml-2 hover:cursor-pointer hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Hapus</button>
                        </form>
                    </div>
              </div>
          </div>

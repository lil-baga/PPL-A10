        ...
        <div class="px-16 py-16">
            <div class=" px-8 py-8 shadow-xl bg-white rounded-lg">
                <div class="flex flex-row">
                    <a href="{{ route('detail.penyuluhan', $penyuluhanTernak->id) }}"
                ...
                <form class="flex flex-col space-y-12 justify-center items-center"
                    action="{{ route('validasi.penyuluhan', $penyuluhanTernak->id) }}" method="POST"
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <input type="datetime-local" id="tanggal_penyuluhan" name="tanggal_penyuluhan"
                                ...
                                placeholder="Berikan Tanggal Penyuluhan..."

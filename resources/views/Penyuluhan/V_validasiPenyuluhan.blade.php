        ...
        <div class="px-12 py-12">
            <div class=" px-6 py-6 shadow-xl bg-white rounded-lg">
                ...
                <form class="flex flex-col space-y-12 justify-center items-center"
                    action="{{ route('validasi.penyuluhan', Crypt::encryptString($penyuluhanTernak->id)) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div>
                        <label for="tanggal_penyuluhan" class="block mb-2 text-sm font-medium text-gray-900">Tanggal
                            Penyuluhan</label>
                        <div
                            ...
                            <input type="datetime-local" id="tanggal_penyuluhan" name="tanggal_penyuluhan"
                                class="p-2 w-96 resize-none border-none align-top focus:ring-0 sm:text-sm" rows="4"
                                placeholder="Berikan Tanggal Penyuluhan..." min="{{ now()->translatedFormat('Y-m-d H:i') }}"
                        ...
                        <div class="flex flex-row items-center justify-center gap-6">
                            ...
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <input type="radio" name="validasi_id" id="Proses" value=2
                                    @if ($penyuluhanTernak->validasi_id == 2) checked @endif
                            ...
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <input type="radio" name="validasi_id" id="Belum" value=3
                                    @if ($penyuluhanTernak->validasi_id == 3) checked @endif

...
@section('content')
    <div class="w-full bg-slate-200 scrollbar">
        ...
        <div class="px-12 py-12">
            <div class="flex text-center items-center justify-center content-center bg-cover bg-center bg-no-repeat bg-[url('img/assets/fotopenyuluhan.png')] bg-slate-500 bg-blend-multiply w-full h-16 mb-4 rounded-lg">

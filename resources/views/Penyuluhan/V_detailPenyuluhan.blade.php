    ...
    <div class="w-full bg-slate-200 scrollbar">
        <div class="px-16 py-16">
            <div class=" px-8 py-8 shadow-xl bg-white rounded-lg">
                ...
                <div class="p-6 flex flex-row gap-32">
                    <div class="flex flex-col items-start justify-inline-start max-w-[512px] gap-8">
                        <div class="space-y-2">
                            ...
                            <a href="{{ url("img/foto_surat/$penyuluhanTernak->surat_pengantar") }}" target="_blank"
                        ...
                        <div class="space-y-2">
                            ...
                            <a href="{{ url("img/foto_surat/$penyuluhanTernak->surat_usaha") }}" target="_blank"
                                class="text-center items-center justify-center w-20 transition-colors bg-slate-900 hover:bg-[#F5682A] flex hover:cursor-pointer text-white font-medium py-2 px-4 rounded gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                    <path fill="currentColor" d="M11.024 11.536L10 10l-2 3h9l-3.5-5z" />
                                    <circle cx="9.503" cy="7.497" r="1.503" fill="currentColor" />
                        ...
                        <div class="space-y-2">
                            <p class="flex font-medium text-sm text-slate-900">Foto Ayam:</p>
                            <a href="{{ url("img/foto_peternak/$penyuluhanTernak->foto_ayam") }}" target="_blank"
                                class="text-center items-center justify-center w-20 transition-colors bg-slate-900 hover:bg-[#F5682A] flex hover:cursor-pointer text-white font-medium py-2 px-4 rounded gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                    <path fill="currentColor" d="M11.024 11.536L10 10l-2 3h9l-3.5-5z" />
                                    <circle cx="9.503" cy="7.497" r="1.503" fill="currentColor" />
                        ...
                        <div class="space-y-2">
                            ...
                            <a href="{{ url("img/foto_peternak/$penyuluhanTernak->foto_peternakan") }}" target="_blank"
                                class="text-center items-center justify-center w-20 transition-colors bg-slate-900 hover:bg-[#F5682A] flex hover:cursor-pointer text-white font-medium py-2 px-4 rounded gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                    <path fill="currentColor" d="M11.024 11.536L10 10l-2 3h9l-3.5-5z" />
                                    <circle cx="9.503" cy="7.497" r="1.503" fill="currentColor" />
                        ...
                        <div class="space-y-2">
                            <p class="flex font-medium text-sm text-slate-900">Foto Menerima Penyuluhan:</p>
                            @if ($penyuluhanTernak->foto_konfirmasi == null)
                                <p class="flex leading-normal text-slate-900">
                                    -
                                </p>
                            @else
                                <a href="{{ url("img/foto_peternak/$penyuluhanTernak->foto_konfirmasi") }}" target="_blank"
                                    class="text-center items-center justify-center w-20 transition-colors bg-slate-900 hover:bg-[#F5682A] flex hover:cursor-pointer text-white font-medium py-2 px-4 rounded gap-2">
                    ...
                    <div class="flex flex-col items-start justify-inline-start max-w-[512px] gap-8">
                        <div class="space-y-2">
                            <label for="suhu_kandang" class="flex mb-1 font-medium text-sm text-slate-900">Suhu Kandang
                                (°C)</label>
                        ...
                        <div class="space-y-2">
                            <label for="kadar_air" class="flex mb-1 font-medium text-sm text-slate-900">Kadar Air
                                (Liter)</label>
                            <input type="text" name="kadar_air" id="kadar_air" placeholder="Jumlah Water Intake"
                                readonly value="{{ $penyuluhanTernak->kadar_air }}"
                                class="border border-slate-300 text-slate-900 sm:text-sm rounded-lg focus:ring-[#F5682A] focus:border-[#F5682A] flex w-full p-2.5"
                                required="">
                        </div>
                        <div class="space-y-2">
                            <p class="flex font-medium text-sm text-slate-900">Status Validasi</p>
                            @if ($penyuluhanTernak->validasi_id == 1)
                                <div
                            ...
                            @elseif($penyuluhanTernak->validasi_id == 3)
                        ...
                        <div class="space-y-2">
                            ...
                            @if ($penyuluhanTernak->konfirmasi_id == 1)
                                <div
                                    class="flex flex-row items-center justify-center bg-green-400 rounded p-2 w-auto gap-1">
                                    <p class="flex antialiased text-sm leading-normal text-slate-900 font-medium">
                                        {{ $konfirmasi }}
                            ...
                            @elseif($penyuluhanTernak->konfirmasi_id == 3)
                                <div class="flex flex-row items-center justify-center bg-red-400 rounded p-2 w-auto gap-1">
                                    <p class="flex antialiased text-sm leading-normal text-slate-900 font-medium">
                                        {{ $konfirmasi }}
                                    </p>
                    ...
                    <div class="flex flex-col items-start justify-inline-start max-w-[512px] gap-8">
                        <div class="space-y-2">
                            <label for="kadar_pakan" class="flex mb-1 font-medium text-sm text-slate-900">Kadar Pakan
                                (Kg)</label>
                            <input type="text" name="kadar_pakan" id="kadar_pakan" placeholder="Jumlah Food Intake"
                                readonly value="{{ $penyuluhanTernak->kadar_pakan }}"
                                class="border border-slate-300 text-slate-900 sm:text-sm rounded-lg focus:ring-[#F5682A] focus:border-[#F5682A] flex w-full p-2.5"
                                required="">
                        </div>
                        <div class="space-y-2">
                            <div>
                                <label for="kondisi_ayam" class="flex mb-1 font-medium text-sm text-slate-900">Kondisi
                                    Ayam</label>
                                <div
                                    ...
                                    <textarea id="kondisi_ayam" name="kondisi_ayam" readonly
                                        class="p-2 w-full h-full resize-none border-none align-top focus:ring-0 sm:text-sm"
                                        placeholder="Kondisi Ayam Peternak">{{ $penyuluhanTernak->kondisi_ayam }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col items-start justify-inline-start max-w-[512px] gap-8">
                        <div class="space-y-2">
                            <label for="tanggal_penyuluhan" class="block mb-2 text-sm font-medium text-slate-900">Tanggal
                                Penyuluhan</label>
                            <div
                                ...
                                <input readonly type="datetime-local" id="tanggal_penyuluhan" name="tanggal_penyuluhan"
                                    class="p-2 w-96 resize-none border-none align-top focus:ring-0 sm:text-sm"
                                    rows="4" placeholder="Berikan Tanggal Penyuluhan..."
                                    value="{{ $penyuluhanTernak->tanggal_penyuluhan }}">
                            </div>
                        </div>
                        <div class="space-y-2">
                            <div>
                                ...
                                <div
                                    ...
                                    <textarea id="catatan" name="catatan" readonly
                                        class="p-2 w-full h-full resize-none border-none align-top focus:ring-0 sm:text-sm"
                                        placeholder="Belum Ada Catatan...">{{ $penyuluhanTernak->catatan }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-row items-center justify-center gap-8 w-full mt-4">
                    @if (Auth::user()->roles_id == 2)
                        @if ($penyuluhanTernak->validasi_id == 2)
                        @else
                            @if ($penyuluhanTernak->konfirmasi_id == 1)
                            @else
                                <a href="{{ route('edit.penyuluhan', Crypt::encryptString($penyuluhanTernak->id)) }}"
                                ...
                                <div class="relative p-4 text-center bg-white rounded-lg sm:p-5">
                                    ...
                                    <div class="flex justify-center items-center space-x-4">
                                        ...
                                        <form id='delete' method="POST"
                                            action="{{ route('destroy.penyuluhan', Crypt::encryptString($penyuluhanTernak->id)) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                    ...
                    @elseif(Auth::user()->roles_id == 3)
                        <a href="{{ route('view.validpenyuluhan', Crypt::encryptString($penyuluhanTernak->id)) }}"

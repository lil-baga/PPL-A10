...
@section('content')
    <div class="w-full bg-slate-200 scrollbar">
        @if (Session::has('success'))
            <div id="alert-border-3" class="flex items-center p-4 text-green-800 border-t-4 border-green-300 bg-green-50"
                role="alert">
                            ...
                            <div class="py-4 px-12 w-full">
                                <div class="w-full bg-white border border-gray-200">
                                    <div class="w-full content-center h-64 overflow-clip">
                                        <img src="{{ url('img/foto_berita/' . $bb->thumbnail) }}" alt="{{ $bb->thumbnail }}"
                                            class="w-full">
                                    </div>

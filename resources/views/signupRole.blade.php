...
@section('title', '| Login')
@section('content')
    <section class="bg-cover bg-center bg-no-repeat bg-[url('img/assets/fotopenyuluhan.png')] bg-slate-700 bg-blend-multiply w-full h-full">
                    ...
                    <div class="space-y-4 md:space-y-6">
                        ...
                        <p class="text-xs md:text-sm font-light text-slate-500 ">
                            Sudah memiliki akun? <a href="/loginRole"
                                class="font-medium text-[#F5682A] hover:text-[#F54C2A] text-xs md:text-sm hover:underline">Login</a>
                        </p>
                    </div>
                </div>
            </div>

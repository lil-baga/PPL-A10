...
<body class="font-[poppins] font-medium overflow-clip">
    <nav
        class="top-0 left-0 z-20 w-full p-2 bg-white border-t border-gray-200 shadow md:items-center md:justify-between @yield('hidden')">
        <div class="w-full flex flex-wrap items-center justify-between p-2">
            <a href="/" class="flex items-center space-x-3 ">
                <img src="{{ url('img/assets/logobrand.png') }}" class="h-8" alt="Chick & Check Logo" />
            </a>
            <div class="flex order-2 space-x-0 gap-2">
                ...
                <a href="/signupRole"
                    class="button text-white bg-[#F5682A] hover:bg-[#F54C2A] focus:bg-transparent focus:text-[#F5682A] focus:ring-2 focus:ring-[#F5682A] font-medium rounded-lg text-sm px-4 py-2 text-center">Sign
                    Up</a>
            </div>
        </div>
    </nav>
    ...
    <footer
        class="fixed font-medium bottom-0 left-0 z-10 w-full p-2 bg-white shadow md:flex md:items-center md:justify-between">
